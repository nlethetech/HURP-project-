...
URLs checked: 8 cited in this report + 45 distinct manifest URLs = 53 unique.
- **PASS** [SWEEP] all cited / manifest URLs resolve: 53/53 resolved
- **PASS** [SWEEP] codebook covers every panel column: 35/35 columns documented
...
| 2 | STRUCTURE | column count | **PASS** | cols=35 expected=35 |
...
| 14 | EXTERNAL | UCDP fatality ratio in expected band | **PASS** | aggregate panel/published = 0.719 (expected band [0.55, 0.95], <1 due to where_prec<=3 keep 85.0% + ~3.7% unmatched); 2020: panel=58,068 / pub=80,100 = 0.725; 2021: panel=85,137 / pub=119,100 = 0.715 |
| 15 | EXTERNAL | FAOSTAT 2020 Maize (corn) vs FAO published | **PASS** | interim=1,153.9 Mt vs published~1,200 Mt (ratio 0.962, tol +/-6%, n_countries=169) |
| 16 | EXTERNAL | FAOSTAT 2020 Wheat vs FAO published | **PASS** | interim=775.8 Mt vs published~760 Mt (ratio 1.021, tol +/-6%, n_countries=124) |
| 17 | EXTERNAL | FAOSTAT 2020 Rice vs FAO published | **PASS** | interim=771.6 Mt vs published~760 Mt (ratio 1.015, tol +/-6%, n_countries=136) |
| 18 | EXTERNAL | Sahara core precip < 150 mm (2020) | **PASS** | n=13 districts; max precip=63.5 mm (threshold <150) |
| 19 | EXTERNAL | Bangladesh precip > 1500 mm (2020) | **PASS** | n=64 districts; min precip=1682.9 mm (threshold >1500) |
| 20 | EXTERNAL | Iowa maize 2010 median in 8-12 t/ha | **PASS** | n=65 districts; median maize yield=9.62 t/ha (band [8.0, 12.0]) |
| 21 | EXTERNAL | 2024 high-income count == World Bank FY26 | **PASS** | interim income_class (data_year=2024) High=87 vs World Bank FY26=87 (https://datahelpdesk.worldbank.org/knowledgebase/articles/906519-world-bank-country-and-lending-groups ) |
| 22 | EXTERNAL | 2008 real wheat/rice price log-change large positive | **PASS** | dlog_real wheat 2008=0.170, rice 2008=0.614 (both should be large positive; 2007-08 food price spike) |
| 23 | EXTERNAL | 2008 high-wheat shock > zero-cropland (NaN) | **PASS** | high-wheat (share>0.5, n=2,940) mean price_shock=0.1268; zero-cropland (n=8,469) price_shock all-NaN=True |
| 24 | MISSINGNESS | documented gaps appear as codebook states | **PASS** | precip_mm 2025 non-null=0.0% (expect 0); yield_maize >2016 non-null=0.0% (expect 0); cropland_ha non-null flat across eras=True |
| 25 | SWEEP | all cited / manifest URLs resolve | **PASS** | 53/53 resolved |
| 26 | SWEEP | codebook covers every panel column | **PASS** | 35/35 columns documented |

**Totals: 26 PASS, 0 FAIL, 0 SKIP (of 26 checks).**
